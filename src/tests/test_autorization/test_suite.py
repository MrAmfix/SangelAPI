...
def test_get_access(create_test_user):
    ...
    response_from_registration = api_requests.registration_api_request(user=create_test_user)
    ...
    response_from_get_access_wrong = api_requests.get_access_api_request(token=wrong_refresh_token)
