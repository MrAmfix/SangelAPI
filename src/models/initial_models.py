...
class User(Base, AsyncAttrs):
    ...
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime_now_moscow)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime_now_moscow, onupdate=datetime_now_moscow)
